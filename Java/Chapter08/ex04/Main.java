...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*	
		NullpointException : null 인 상태의 값에 무언가를 하려 할 경우 *******
		String data = null;
		data.toString();
		*/
		...
		*/
		...
		/*ClassCastException: 부모 형태로 들어간 객체가 다시 되돌아 올때 잘못 되돌아온 경우 
		Object val = 1234; // Object 는 java의 모든것이 다 들어간다. 
		int intVal = (int) val; //본래 형태로 되돌아 가는건 문제 없음
		String strVal = (String) val; //문자열로 되돌아 가려고 한다면?
		*/

		//NumberFormatException : 숫자형태가 아닌 문자열을 숫자로 변경 하려고 할 경우 
		String data = "1234";
		int intVal;
